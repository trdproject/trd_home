...
<div class="container">
  <div class="team-text"  style="background-color: #010321;" align="Center">
    <h2 style="color:white; font-family: Segoe UI Light; font-size: 40px; padding-top: 15px; padding-bottom: 15px;"><strong>
...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <div class="row">
        <div class="column" style="-ms-flex: 25%; flex: 25%; max-width: 50%; padding: 0 4px; margin-left: 20px;" align="center">
          <div id="accordion" class="accordion-area" style="width: 500px;">
          <div class="panel">
                ...
                <?php if($product->num_rows() > 0): ?>
                   <?php foreach ($product->result() as $key) { ?>
                    <?php 
                          ...
                          $print = $trans->translate($source, $target, $text);
                    ?>
                  <div class="tab-pane fade" id="<?php echo $key->id_product;?>" role="tabpanel" aria-labelledby="<?php echo $key->id_product;?>">
                    ...
                    <div class="info-box">
                      ...
                      <p style="font-family: Segoe UI Light; color: #040133;  text-align: center; font-size: 16px;">
                        <?php echo $print; ?>
                      </p>
                    </div>
                  </div>
        ...
        <div class="column" style="-ms-flex: 25%; flex: 25%; max-width: 50%; padding: 0 4px; margin-right: 20px;" align="center">
          <div id="accordion" class="accordion-area" style="width: 500px;">
          <div class="panel">
            <div class="panel-header" id="headingOne" >
                <button class="panel-link" data-toggle="collapse" data-target="#collapse1" aria-expanded="false" aria-controls="collapse1" style="background-color:#0e0c31; "><h2 class="sb-title" style="color: white; font-size: 30px;">
                Ratna Engine
              </h2></button>
            </div>
