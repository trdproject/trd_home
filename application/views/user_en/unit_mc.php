		...
		<div class="row">
			...
			<div class="col-lg-10">
				<div class="about-text" align="Center">
					<p style="font-family: Segoe UI Light; font-size: 20px; color: black;">
					<?php
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="video-text">
					...
					<a href="<?php echo site_url();?>English/qc_mc" class="site-btn sb-light-dark">details</a>
				</div>
			</div>
			<div class="col-lg-6">
...
<section class="team-section spad">
	<div class="container">
		<div class="team-text" style="font-family: Segoe UI; font-size: 45px; color: #000230;">
			...
			<b><font color="#040133">OUR </font><font color="#0070b7">PRODUCT</font></b>
