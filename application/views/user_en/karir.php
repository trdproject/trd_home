...
<html lang="zxx">
<head>
	<title>Career | PT Tri Ratna Diesel Indonesia</title>
...
<section class="elements-section spad" >
	<div class="container">
		<div class="client-text" style="color:  #000066; font-family: Segoe UI; font-size: 45px;">
			<font color="#008fb3"><b>PT TRI RATNA DIESEL INDONESIA</b></font>
			<br>RECRUITMENT
		</div>
		<!-- element -->
		<div class="element">
			...
			<div class="panel">
				<div class="panel-header" id="headingOne">
					<button class="panel-link" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1" style="background-color: #081135;"><h4 style="color: white;">Internship</h4></button>
				</div>
				<div id="collapse1" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
					...
					<?php if ($magang == NULL ) {?>
						<div class='alert' align='Center'>
							 <strong> Sorry, there are currently no jobs.
							 </strong>
						</div>
						<?php	} else {
			...
			<div class="panel">
				<div class="panel-header" id="headingTwo">
					<button class="panel-link" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2" style="background-color: #081135"><h4 style="color: white;">Job Vacancy</h4></button>
				</div>
