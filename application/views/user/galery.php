	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-6 sidebar order-2 order-lg-1">
				...
				<div class="sb-widget">
					<h2 class="sb-title">Event Lainnya</h2>
					<div class="recent-post">
						<?php foreach ($list as $data) { ?>
						<div class="rp-item">
							<a href="<?php echo site_url();?>detail-acara/<?php echo $data['id_event'];?>">
								<img src="<?php echo base_url();?>upload/media/<?php echo $data['file_name']?>" alt="" height="99px" width="99px">
								<div class="rp-text">
									<p><?php echo $data['title']?></p>
									<span class="label info" style="font-size: 12px;"><?php echo date('d M, Y',  strtotime($data['date_event']))?></span>
								</div>
							</a>
						</div>
						<?php } ?>
			...
			<div class="col-lg-8 order-1 order-lg-2">
				...
				<div class="blog-post">
					...
					<h2 style="font-family: Segoe UI Light; "><?php echo $key['title']; ?></h2>
					<a href="<?php echo site_url();?>detail-acara/<?php echo $key['id_event'];?>" class="site-btn sb-light-dark">detail</a>
				</div>
				<?php } ?>
			</div>
		</div>
