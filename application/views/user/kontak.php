		...
		<div class="row">
			...
			<div class="col-lg-4">
				...
				<form class="contact-form" method="post" action="<?php echo site_url(); ?>Home/insert">
					<div class="row">
						<div class="col-lg-6">
							<input type="text" placeholder="Nama" name="input_name" oninvalid="" required>
						</div>
						<div class="col-lg-6">
							<input type="email" placeholder="Email" name="input_email" oninvalid="" required>
						</div>
						<div class="col-lg-4">
						</div>
						<div class="col-lg-12">
							<input type="text" placeholder="Subyek" name="input_subject" oninvalid="" required>
							<textarea class="text-msg" placeholder="Pesan" name="input_message" oninvalid="" required></textarea>
							<button class="site-btn sb-light-dark" type="submit" name="submit">KIRIM PESAN</button>
						</div>
					</div>
				</form>
			</div>
