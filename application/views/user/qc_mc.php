...
<section class="services-section">
	<div class="our-warp">
		...
		<div  class="container" style="padding-left: 70px; padding-right: 70px; font-family:  Segoe UI Light; font-size: 22px" align="Center">
			<ol>Untuk menjaga hasil agar tetap berkualitas, kami selalu melakukan pengecekan ulang mulai dari bahan kimia yang digunakan, sifat-sifat mekanik, sifat-sifat fisik, dan dimensinya.
			</ol>
...
<div class="container" >
	...
	<h2 align="left" style="font-family: Segoe UI Light; "><img src="<?php echo base_url('upload/qc/lk.png');?>" width="30px" height="30px" > ALAT UKUR  </h2>
	<p style="padding-left: 35px; font-family: Segoe UI Light; color: black; font-size: 18px;">Untuk memberikan hasil yang sesuai permintaan, kami menyediakan alat ukur yang terbaik, dengan ketelitian akurasi yang tinggi</p>
	<div class="col-lg-12">
	<div class="row"> 
		<div class="column" style="-ms-flex: 25%; flex: 25%; max-width: 50%; padding: 0 4px;">
			<div class="img" style="margin-top: 8px; vertical-align: middle; width: 100%;">
